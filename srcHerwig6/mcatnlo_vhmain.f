...
c sigma (pb) = 10^6 * sigma (mub)
     ...
     #  ffunction5,zg2_mc,zgmu2_mc,ytmp,zhwfct,zherw_spl,x1t,x2t,
...
c MC subtraction terms; ffunval5=0,1 --> dead zone, live zone
        ...
        if(ffunval5.ne.0.d0)then
          ...
          if(x1t.lt.1.and.x2t.lt.1)then
            ...
            do jproc=loproc,maproc
              call xmcsubt(jproc,idec,xmv2,xmh2,s,x,yi,cth1,cth2,
...
c
c
      subroutine xmcsubt(jproc,idec,xm12,xm22,s,x,y,cth1,cth2,
