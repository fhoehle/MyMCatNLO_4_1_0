...
c
      ...
      do i=1,4
        ...
        enddo
      enddo
      call propagators(coq2,dummy,props)
      jmin=3
      jmax=3
...
c
      ...
      do i=1,4
        ...
        enddo
      enddo
      call propagators(coq2,xmv2,props)
      jmin=3
      jmax=3
      if(stype.eq.'born')then
        i1=2
     ...
     #                props(j)*axialr/(2*s)
      ...
      subroutine propagators(xsvh,xsll,props)
...
c final-state V propagators. In the case of undecayed vector boson, the
