...
c includiamo un fattore -2*tt/s (wz3g = -2*uu*s*M^2)
     ...
     #                zzffg(x,y,tt,uu,q1c,q2c,s,ymz2) )/2.d0
      ...
      subroutine vbborn2(s,x,y,cth1,cth2,brnup,brndo)
      implicit none
      real * 8 s,x,y,cth1,cth2,brnup,brndo
      real * 8 zero,one,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,
     # dkswzborn,xsecup,xsecdo
      parameter (zero=0.d0)
      parameter (one=1.d0)
      integer ione
      parameter (ione=1)
...
c
      call invar(zmw2,zmz2,s,one,y,cth1,cth2,zero,zero,zero,zero,
     #  str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
      if(prdct.eq.'w+'.or.prdct.eq.'w-') then
        brnup=dkswzborn(zmw2,zmz2,s,one,y,cth1,cth2,
     #                  str,tk,uk,q1q,q2q)
        brndo=0.d0
      elseif(prdct.eq.'ww') then
        call dkswwborn(zmw2,zmz2,s,one,y,cth1,cth2,
     #                 str,tk,uk,q1q,q2q,xsecup,xsecdo) 
        brnup=xsecup
        brndo=xsecdo
      else
        write(*,*)'Error in vbborn2: non implemented final state', 
     #            prdct
        stop
      endif
      if(ianomsvt.eq.0)
     ...
     #    str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
      ...
      subroutine vb22(s,x,y,cth1,cth2,ww2up,ww2do)
      implicit none
      real * 8 s,x,y,cth1,cth2,ww2up,ww2do
      real * 8 zero,one,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,
     # dkswzsv,xsecup,xsecdo
      parameter (zero=0.d0)
      parameter (one=1.d0)
      integer ione
      parameter (ione=1)
...
c
     ...
     #  str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
      if(prdct.eq.'w+'.or.prdct.eq.'w-') then
        ww2up=dkswzsv(zmw2,zmz2,s,one,y,cth1,cth2,
     #                str,tk,uk,q1q,q2q)
        ww2do=0.d0
      elseif(prdct.eq.'ww') then
        call dkswwsv(zmw2,zmz2,s,one,y,cth1,cth2,
     #               str,tk,uk,q1q,q2q,xsecup,xsecdo) 
        ww2up=xsecup
        ww2do=xsecdo
      else
        write(*,*)'Error in vb22: non implemented final state', 
     #            prdct
        stop
      endif
      if(ianomsvt.eq.0)
     ...
     #    str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
      ...
      subroutine vbppcolp_dks(s,x,y,cth1,cth2,q1q,q2q,xlmude,
     #                        wwpup,wwpdo)
      implicit none
      real * 8 s,x,y,cth1,cth2,q1q,q2q,xlmude,wwpup,wwpdo,zero
      parameter (zero=0.d0)
      logical avg
      parameter (avg=.true.)
c
      call vbppcolp_wrap(s,x,y,cth1,cth2,q1q,q2q,xlmude,wwpup,wwpdo,
     #                   zero,zero,zero,zero,avg)
      return
      end


      subroutine vbppcolp2_dks(s,x,y,cth1,cth2,q1q,q2q,xlmude,
     #                         wwpup,wwpdo,phil,cthl,phir,cthr)
      implicit none
      real * 8 s,x,y,cth1,cth2,q1q,q2q,xlmude,wwpup,wwpdo,
     #  phil,cthl,phir,cthr
      logical avg
      parameter (avg=.true.)
c Set avg=.false. here if weights are to be recomputed with the
c fully decayed matrix elements (testing)
c
      call vbppcolp_wrap(s,x,y,cth1,cth2,q1q,q2q,xlmude,wwpup,wwpdo,
     #                   phil,cthl,phir,cthr,avg)
      return
      end


      subroutine vbppcolp_wrap(s,x,y,cth1,cth2,q1q,q2q,xlmude,
     #                         wwpup,wwpdo,phil,cthl,phir,cthr,avg)
      implicit none
      real * 8 s,x,y,cth1,cth2,xlmude,wwpup,wwpdo
      real * 8 phil,cthl,phir,cthr
      logical avg
      real * 8 sx,ro,beta,tbar,cth1bar,dkswzborn,tk,uk,q1q,q2q,
     # xfact,dis,v1a,v1b,v1c,v3a,v3b,v3c,v13,bornup,borndo,xkpqq,xkpqg,
     # dkswzborn2
      real * 8 zero,one,vcf,vtf
      parameter (zero=0.d0)
      parameter (one=1.d0)
...
c
      if(prdct.eq.'z ')then
        write(*,*) 
     #    'Error in vbppcolp_wrap: non implemented final state', prdct
        stop
      endif
c
      wwpup=0.d0
      wwpdo=0.d0
      sx=s*x
      ro=2*(zmw2+zmz2)/sx-(zmw2-zmz2)**2/sx**2
      beta=sqrt(1-ro)
      if(y.eq.1.d0)then
        tbar=q2q
        if(prc.eq.'ag')tbar=zmw2+zmz2-sx-tbar
      elseif(y.eq.-1.d0)then
        tbar=q1q
        if(prc.eq.'ag')tbar=zmw2+zmz2-sx-tbar
      else
        write(6,*) 'Error in vbppcolp_wrap: y=',y
        stop
      endif
      cth1bar=1/beta*(1+(2*tbar-zmw2-zmz2)/sx)
      call invar(zmw2,zmz2,sx,one,y,cth1bar,cth2,phil,cthl,phir,
     #  cthr,str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
      if(prdct.eq.'w+'.or.prdct.eq.'w-')then
        if(avg)then
          bornup=dkswzborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                     str,tk,uk,q1q,q2q)
        else
          bornup=dkswzborn2(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                      phil,cthl,phir,cthr,str,tk,uk,q1q,q2q,
     #                      v1a,v1b,v1c,v3a,v3b,v3c,v13)
        endif
        if(prc.eq.'qq') then
          xfact=2*(xlmude*(1+x**2)+(1-x)**2)
          ...
          wwpup = 4/3.d0*xfact*bornup
          wwpdo = 0.d0
        elseif(prc.eq.'qg'.or.prc.eq.'ag') then
          xfact=2*( (xlmude + 2*log(1-x)) * (x**2+(1-x)**2)
     #             + 2*x*(1-x) )
          if(scheme.eq.'DI') then
          ...
          wwpup = .5d0*(1-x)*xfact*bornup
          wwpdo = 0.d0
        else
          write(6,*) 'Error in vbppcolp_wrap: prc=',prc
          stop
        endif
      elseif(prdct.eq.'ww')then
        if(avg)then
          call dkswwborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                   str,tk,uk,q1q,q2q,bornup,borndo) 
        else
          call dkswwborn2(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                    phil,cthl,phir,cthr,str,tk,uk,q1q,q2q,
     #                    v1a,v1b,v1c,v3a,v3b,v3c,v13,bornup,borndo) 
        endif
        if(prc.eq.'qq') then
          ...
          elseif(scheme.ne.'MS') then
            write(6,*)'vbppcolp_wrap: scheme not known'
            stop
          endif
          wwpup = xfact*bornup
          wwpdo = xfact*borndo
        elseif(prc.eq.'qg'.or.prc.eq.'ag') then
c At variance with the case of WZ, the original WW code sets these
c matrix elements equal to zero for collinearity to q
          if(y.eq.1.d0)then
            wwpup = 0.d0
            wwpdo = 0.d0
          else
...
c
     ...
     #    str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
      ...
      subroutine vbppcoll_dks(s,x,y,cth1,cth2,q1q,q2q,wwlup,wwldo)
      implicit none
      real * 8 s,x,y,cth1,cth2,q1q,q2q,wwlup,wwldo,zero
      parameter (zero=0.d0)
      logical avg
      parameter (avg=.true.)
c
      call vbppcoll_wrap(s,x,y,cth1,cth2,q1q,q2q,wwlup,wwldo,
     #                   zero,zero,zero,zero,avg)
      return
      end


      subroutine vbppcoll2_dks(s,x,y,cth1,cth2,q1q,q2q,wwlup,wwldo,
     #                         phil,cthl,phir,cthr)
      implicit none
      real * 8 s,x,y,cth1,cth2,q1q,q2q,wwlup,wwldo,phil,cthl,phir,cthr
      logical avg
      parameter (avg=.true.)
c Set avg=.false. here if weights are to be recomputed with the
c fully decayed matrix elements (testing)
c
     ...
     #                   phil,cthl,phir,cthr,avg)
      ...
      subroutine vbppcoll_wrap(s,x,y,cth1,cth2,q1q,q2q,wwlup,wwldo,
     #                         phil,cthl,phir,cthr,avg)
      implicit none
      real * 8 s,x,y,cth1,cth2,q1q,q2q,wwlup,wwldo
      real * 8 phil,cthl,phir,cthr
      logical avg
      real * 8 sx,ro,beta,tbar,cth1bar,dkswzborn,dkswzborn2,tk,uk,
     #  xfact,dis,v1a,v1b,v1c,v3a,v3b,v3c,v13,bornup,borndo,xklqq,
     #  xklqg
      real * 8 zero,one,vcf,vtf
      parameter (zero=0.d0)
      parameter (one=1.d0)
...
c
      if(prdct.eq.'w+'.or.prdct.eq.'w-')then
        sx=s*x
        call invar(zmw2,zmz2,sx,one,y,cth1,cth2,phil,cthl,phir,cthr,
     #    str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
cSF CHECK HERE. WHY THERE WAS NO CTH1BAR?
        if(avg)then
          bornup=dkswzborn(zmw2,zmz2,sx,one,y,cth1,cth2,
     #                     str,tk,uk,q1q,q2q)
        else
          bornup=dkswzborn2(zmw2,zmz2,sx,one,y,cth1,cth2,
     #                      phil,cthl,phir,cthr,str,tk,uk,q1q,q2q,
     #                      v1a,v1b,v1c,v3a,v3b,v3c,v13)
        endif
        if(prc.eq.'qq') then
          ...
          wwlup = 4/3.d0*xfact*bornup
          wwldo = 0.d0
        elseif(prc.eq.'qg'.or.prc.eq.'ag') then
          wwlup = 0.d0
          wwldo = 0.d0
        else
          write(6,*) 'Error in vbppcoll_wrap: prc=',prc
          stop
        endif
      elseif(prdct.eq.'ww')then
        sx=s*x
        ...
        elseif(y.eq.-1.d0)then
          ...
          write(6,*) 'Error in vbppcoll_wrap: y=',y
          stop
        endif
cSF CHECK HERE. WHY THERE IS CTH1BAR AT VARIANCE WITH WZ?
        cth1bar=1/beta*(1+(2*tbar-zmw2-zmz2)/sx)
        call invar(zmw2,zmz2,sx,one,y,cth1bar,cth2,phil,cthl,phir,
     #    cthr,str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
        if(avg)then
     ...
     #                    v1a,v1b,v1c,v3a,v3b,v3c,v13,bornup,borndo) 
        ...
        if(prc.eq.'qq') then
          ...
          elseif(scheme.ne.'MS') then
            write(6,*)'vbppcoll_wrap: scheme not known'
            stop
          endif
          wwlup = xfact*bornup
          wwldo = xfact*borndo
...
c matrix elements equal to zero for collinearity to q
        ...
        write(*,*) 
     #    'Error in vbppcoll_wrap: non implemented final state', prdct
        stop
      endif
      if(ianomsvt.eq.0)
     #  call invar(zmw2,zmz2,s,x,y,cth1,cth2,phil,cthl,phir,cthr,
     #    str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
      ...
      subroutine vbfpp_dks(s,x,y,cth1,cth2,tk,uk,q1q,q2q,ww3up,ww3do)
      implicit none
      real * 8 s,x,y,cth1,cth2,tk,uk,q1q,q2q,ww3up,ww3do,zero
      parameter (zero=0.d0)
      logical avg
      parameter (avg=.true.)
c
      call vbfpp_wrap(s,x,y,cth1,cth2,tk,uk,q1q,q2q,ww3up,ww3do,
     #                zero,zero,zero,zero,avg)
      return
      end


      subroutine vbfpp2_dks(s,x,y,cth1,cth2,tk,uk,q1q,q2q,ww3up,ww3do,
     #                      phil,cthl,phir,cthr)
      implicit none
      real * 8 s,x,y,cth1,cth2,tk,uk,q1q,q2q,ww3up,ww3do,
     #  phil,cthl,phir,cthr
      logical avg
      parameter (avg=.true.)
c Set avg=.false. here if weights are to be recomputed with the
...
c
     ...
     #                phil,cthl,phir,cthr,avg)
      ...
      subroutine vbfpp_wrap(s,x,y,cth1,cth2,tk,uk,q1q,q2q,ww3up,ww3do,
     #                      phil,cthl,phir,cthr,avg)
      implicit none
      real * 8 s,x,y,cth1,cth2,tk,uk,q1q,q2q,ww3up,ww3do
      real * 8 phil,cthl,phir,cthr
      logical avg
      real * 8 sx,ro,beta,cth1bar,v1a,v1b,v1c,v3a,v3b,v3c,v13,
     # tmpupp,tmpupm,tmpdop,tmpdom,tbar,dkswzborn,dkswzreal,
     # dkswzborn2,dkswzreal2

      real * 8 tiny,zero,one,vcf,vtf
...
c
      if(prdct.eq.'z ')then
        write(*,*) 
     #    'Error in vbfpp_wrap: non implemented final state', prdct
        stop
      endif
c
      ww3up=0.d0
      ...
      if(1-x.le.tiny)then
        if(prc.eq.'qq')then
          ...
          ro=2*(zmw2+zmz2)/sx-(zmw2-zmz2)**2/sx**2
          beta=sqrt(1-ro)
          cth1bar=1/beta*(1+(2*q2q-zmw2-zmz2)/sx)
          call invar(zmw2,zmz2,sx,one,y,cth1bar,cth2,phil,cthl,phir,
     #      cthr,str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
          if(prdct.eq.'w+'.or.prdct.eq.'w-') then
            if(avg)then
              tmpupp=dkswzborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                         str,tk,uk,q1q,q2q)
            else
              tmpupp=dkswzborn2(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                          phil,cthl,phir,cthr,str,tk,uk,q1q,q2q,
     #                          v1a,v1b,v1c,v3a,v3b,v3c,v13)
            endif
            tmpupp=8*s*(1+x**2)*tmpupp
          elseif(prdct.eq.'ww')then
            if(avg)then
              call dkswwborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                       str,tk,uk,q1q,q2q,tmpupp,tmpdop)
            else
              call dkswwborn2(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                        phil,cthl,phir,cthr,str,tk,uk,q1q,q2q,
     #                        v1a,v1b,v1c,v3a,v3b,v3c,v13,
     #                        tmpupp,tmpdop)
            ...
            tmpupp=16*s*vcf*tmpupp
            tmpdop=16*s*vcf*tmpdop
          endif
          cth1bar=1/beta*(1+(2*q1q-zmw2-zmz2)/sx)
          call invar(zmw2,zmz2,sx,one,y,cth1bar,cth2,phil,cthl,phir,
     #      cthr,str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
          if(prdct.eq.'w+'.or.prdct.eq.'w-') then
            if(avg)then
              tmpupm=dkswzborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                         str,tk,uk,q1q,q2q)
            else
              tmpupm=dkswzborn2(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                          phil,cthl,phir,cthr,str,tk,uk,q1q,q2q,
     #                          v1a,v1b,v1c,v3a,v3b,v3c,v13)
            endif
            tmpupm=8*s*(1+x**2)*tmpupm
            ww3up=4/3.d0*(tmpupp+tmpupm)/2.d0
          elseif(prdct.eq.'ww')then
            if(avg)then
              call dkswwborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                       str,tk,uk,q1q,q2q,tmpupp,tmpdop)
     ...
     #      cthr,str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
          if(prdct.eq.'w+'.or.prdct.eq.'w-') then
            if(avg)then
              ww3up=dkswzborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                        str,tk,uk,q1q,q2q)
            else
              ww3up=dkswzborn2(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                         phil,cthl,phir,cthr,str,tk,uk,q1q,q2q,
     #                         v1a,v1b,v1c,v3a,v3b,v3c,v13)
            endif
            ww3up=4/3.d0*8*s*(1+x**2)*ww3up
          elseif(prdct.eq.'ww')then
            if(avg)then
              call dkswwborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     #                       str,tk,uk,q1q,q2q,tmpupp,tmpdop)
     ...
     #                        tmpupp,tmpdop)
            ...
            ww3up=4*vcf*s*(1+y)*(1+x**2)*tmpupp
            ww3do=4*vcf*s*(1+y)*(1+x**2)*tmpdop
          endif
        endif
      elseif(1+y.le.tiny)then
        sx=s*x
        ...
        if(prc.eq.'qq'.or.prc.eq.'qg')then
          tbar=q1q
        elseif(prc.eq.'ag')then
          tbar=zmw2+zmz2-sx-q1q
        endif
        cth1bar=1/beta*(1+(2*tbar-zmw2-zmz2)/sx)
        call invar(zmw2,zmz2,sx,one,y,cth1bar,cth2,phil,cthl,phir,cthr
     #    ,str,tk,uk,q1q,q2q,v1a,v1b,v1c,v3a,v3b,v3c,v13,ione)
        if(prdct.eq.'w+'.or.prdct.eq.'w-') then
          if(avg)then
            ww3up=dkswzborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     ...
     #                       v1a,v1b,v1c,v3a,v3b,v3c,v13)
          ...
          if(prc.eq.'qq')then
            ...
            ww3up=0.5d0*(1-x)*(1-y)*4*s*(x**2+(1-x)**2)*ww3up
          endif
        elseif(prdct.eq.'ww')then
          if(avg)then
            call dkswwborn(zmw2,zmz2,sx,one,y,cth1bar,cth2,
     ...
     #                      tmpupp,tmpdop)
          ...
          if(prc.eq.'qq')then
            ...
            ww3up=4*vtf*s*(1-y)*(1-x)*(x**2+(1-x)**2)*tmpupp
            ww3do=4*vtf*s*(1-y)*(1-x)*(x**2+(1-x)**2)*tmpdop
          endif
        endif
      else
        if(prdct.eq.'w+'.or.prdct.eq.'w-') then
          if(avg)then
            ww3up=dkswzreal(zmw2,zmz2,s,x,y,cth1,cth2,str,
     #                      tk,uk,q1q,q2q) 
          else
            ww3up=dkswzreal2(zmw2,zmz2,s,x,y,cth1,cth2,phil,cthl,
     #                       phir,cthr,str,tk,uk,q1q,q2q,v1a,v1b,
     #                       v1c,v3a,v3b,v3c,v13)
          endif
        elseif(prdct.eq.'ww')then
          if(avg)then
            call dkswwreal(zmw2,zmz2,s,x,y,cth1,cth2,str,
     #                     tk,uk,q1q,q2q,ww3up,ww3do)
          else
            call dkswwreal2(zmw2,zmz2,s,x,y,cth1,cth2,phil,cthl,
     #                      phir,cthr,str,tk,uk,q1q,q2q,v1a,v1b,
     #                      v1c,v3a,v3b,v3c,v13,ww3up,ww3do)
          endif
        endif
      endif
c
