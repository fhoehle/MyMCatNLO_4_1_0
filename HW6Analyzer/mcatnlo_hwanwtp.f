...
c Spin correlations are included
        do j=1,2
          ...
          call mbook(k+ 4,'l[W] pt'//cc(j),2.e0,0.e0,200.e0)
          call mbook(k+ 5,'nu[W] pt'//cc(j),2.e0,0.e0,200.e0)
          ...
          call mbook(k+ 9,'l[W] y'//cc(j),0.2e0,-9.e0,9.e0)
          call mbook(k+10,'nu[W] y'//cc(j),0.2e0,-9.e0,9.e0)
...
c Spin correlations are not included
        do j=1,2
          k=(j-1)*20
          call mbook(k+ 1,'Wt pt'//cc(j),2.e0,0.e0,200.e0)
          call mbook(k+ 2,'Wt log[pt]'//cc(j),0.05e0,0.1e0,5.e0)
          call mbook(k+ 3,'Wt inv m'//cc(j),10.e0,240.e0,800.e0)
          call mbook(k+ 4,'Wt azimt'//cc(j),pi/20.e0,0.e0,pi)
          call mbook(k+ 5,'Wt log[pi-azimt]'//cc(j),0.05e0,-4.e0,0.1e0)
          call mbook(k+ 6,'Wt del R'//cc(j),pi/20.e0,0.e0,3*pi)
          call mbook(k+ 7,'t pt'//cc(j),2.e0,0.e0,200.e0)
          call mbook(k+ 8,'W pt'//cc(j),2.e0,0.e0,200.e0)
          call mbook(k+ 9,'t y'//cc(j),0.2e0,-9.e0,9.e0)
          call mbook(k+10,'W y'//cc(j),0.2e0,-9.e0,9.e0)
        enddo
      else
...
C----------------------------------------------------------------------
      ...
      COMMON/VVLIN/IVLEP1,IVLEP2
C
      OPEN(UNIT=99,FILE='HERWT.TOP',STATUS='UNKNOWN')
...
c
      if(idec.eq.0)then
        do j=1,2
          ...
          call multitop(100+k+ 4,99,3,2,'l[W] pt',' ','LOG')
          call multitop(100+k+ 5,99,3,2,'nu[W] pt',' ','LOG')
          call multitop(100+k+ 6,99,3,2,'l[t] y',' ','LOG')
          call multitop(100+k+ 7,99,3,2,'nu[t] y',' ','LOG')
          call multitop(100+k+ 8,99,3,2,'b[t] y',' ','LOG')
          call multitop(100+k+ 9,99,3,2,'l[W] y',' ','LOG')
          call multitop(100+k+10,99,3,2,'nu[W] y',' ','LOG')
      ...
      elseif(idec.eq.1)then
        do j=1,2
          k=(j-1)*20
          call multitop(100+k+ 1,99,2,3,'Wt pt',' ','LOG')
          call multitop(100+k+ 2,99,2,3,'Wt log[pt]',' ','LOG')
          call multitop(100+k+ 3,99,2,3,'Wt inv m',' ','LOG')
          call multitop(100+k+ 4,99,2,3,'Wt azimt',' ','LOG')
          call multitop(100+k+ 5,99,2,3,'Wt log[pi-azimt]',' ','LOG')
          call multitop(100+k+ 6,99,2,3,'Wt del R',' ','LOG')
          call multitop(100+k+ 7,99,2,3,'t pt',' ','LOG')
          call multitop(100+k+ 8,99,2,3,'W pt',' ','LOG')
          call multitop(100+k+ 9,99,2,3,'t y',' ','LOG')
          call multitop(100+k+10,99,2,3,'W y',' ','LOG')
        enddo
      else
