...
c Spin correlations are included
        do j=1,2
          ...
          call rbook(k+ 4,'l[H] pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 5,'nu[H] pt'//cc(j),2.e0,0.e0,200.e0)
          ...
          call rbook(k+ 9,'l[H] y'//cc(j),0.2e0,-9.e0,9.e0)
          call rbook(k+10,'nu[H] y'//cc(j),0.2e0,-9.e0,9.e0)
...
c Spin correlations are not included
        do j=1,2
          k=(j-1)*20
          call rbook(k+ 1,'Ht pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 2,'Ht log[pt]'//cc(j),0.05e0,0.1e0,5.e0)
          call rbook(k+ 3,'Ht inv m'//cc(j),10.e0,240.e0,800.e0)
          call rbook(k+ 4,'Ht azimt'//cc(j),pi/20.e0,0.e0,pi)
          call rbook(k+ 5,'Ht log[pi-azimt]'//cc(j),0.05e0,-4.e0,0.1e0)
          call rbook(k+ 6,'Ht del R'//cc(j),pi/20.e0,0.e0,3*pi)
          call rbook(k+ 7,'t pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 8,'H pt'//cc(j),2.e0,0.e0,200.e0)
