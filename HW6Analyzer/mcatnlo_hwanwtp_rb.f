...
c
      call rinit("HERWT.root")
      if(idec.eq.0)then
c Spin correlations are included
        do j=1,2
          k=(j-1)*20
          call rbook(k+ 1,'l[t] pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 2,'nu[t] pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 3,'b[t] pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 4,'l[W] pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 5,'nu[W] pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 6,'l[t] y'//cc(j),0.2e0,-9.e0,9.e0)
          call rbook(k+ 7,'nu[t] y'//cc(j),0.2e0,-9.e0,9.e0)
          call rbook(k+ 8,'b[t] y'//cc(j),0.2e0,-9.e0,9.e0)
          call rbook(k+ 9,'l[W] y'//cc(j),0.2e0,-9.e0,9.e0)
          call rbook(k+10,'nu[W] y'//cc(j),0.2e0,-9.e0,9.e0)
          call rbook(k+11,'ll pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+12,'ll dphi'//cc(j),pi/20.e0,0.e0,pi)
          call rbook(k+13,'ll m'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+14,'ll DelR'//cc(j),pi/20.e0,0.e0,3*pi)
        enddo
      elseif(idec.eq.1)then
c Spin correlations are not included
        do j=1,2
          k=(j-1)*20
          call rbook(k+ 1,'Wt pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 2,'Wt log[pt]'//cc(j),0.05e0,0.1e0,5.e0)
          call rbook(k+ 3,'Wt inv m'//cc(j),10.e0,240.e0,800.e0)
          call rbook(k+ 4,'Wt azimt'//cc(j),pi/20.e0,0.e0,pi)
          call rbook(k+ 5,'Wt log[pi-azimt]'//cc(j),0.05e0,-4.e0,0.1e0)
          call rbook(k+ 6,'Wt del R'//cc(j),pi/20.e0,0.e0,3*pi)
          call rbook(k+ 7,'t pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 8,'W pt'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+ 9,'t y'//cc(j),0.2e0,-9.e0,9.e0)
          call rbook(k+10,'W y'//cc(j),0.2e0,-9.e0,9.e0)
        enddo
      else
...
c
      ...
      IF(JPR.NE.203)CALL HWWARN('HWANAL',502)
...
C FOUND A TOP
          ...
          ENDDO
        ENDIF
        IF( ((ISTHEP(IHEP).EQ.195.AND.IVLEP2.EQ.7).OR.
     #       (ISTHEP(IHEP).EQ.155.AND.IVLEP2.LT.7)) .AND.
     #      ABS(IDHEP(IHEP)).EQ.24 )THEN
C FOUND A W
          IW=IW+1
          JW(IW)=IHEP
          DO I=1,4
...
C FILL THE FOUR-MOMENTA OF THE DECAY PRODUCTS
        ...
        ENDDO
      ELSE
C CONSTRUCT THE Wt PAIR MOMENTUM; PRIMARY TOP AND W ARE THE FIRST ON RECORD
        DO I=1,4
...
c no veto
        kk=0
        call rfill(kk+ 1,sngl(xptlt),sngl(WWW0))
        call rfill(kk+ 2,sngl(xptnut),sngl(WWW0))
        call rfill(kk+ 3,sngl(xptbt),sngl(WWW0))
        call rfill(kk+ 4,sngl(xptlw),sngl(WWW0))
        call rfill(kk+ 5,sngl(xptnuw),sngl(WWW0))
        call rfill(kk+ 6,sngl(xylt),sngl(WWW0))
        call rfill(kk+ 7,sngl(xynut),sngl(WWW0))
        call rfill(kk+ 8,sngl(xybt),sngl(WWW0))
        call rfill(kk+ 9,sngl(xylw),sngl(WWW0))
        call rfill(kk+10,sngl(xynuw),sngl(WWW0))
        call rfill(kk+11,sngl(xptll),sngl(WWW0))
        call rfill(kk+12,sngl(dphill),sngl(WWW0))
        call rfill(kk+13,sngl(xmll),sngl(WWW0))
        call rfill(kk+14,sngl(xlldelr),sngl(WWW0))
c with veto
        kk=20
        if(vetocut)then
          call rfill(kk+ 1,sngl(xptlt),sngl(WWW0))
...
c no veto
        kk=0
        call rfill(kk+ 1,sngl(xptwt),sngl(WWW0))
        if(xptwt.gt.0.d0)
     #    call rfill(kk+ 2,sngl(log10(xptwt)),sngl(WWW0))
        call rfill(kk+ 3,sngl(wtm),sngl(WWW0))
        call rfill(kk+ 4,sngl(azi),sngl(WWW0))
        if(azinorm.gt.0.d0) 
     #    call rfill(kk+ 5,sngl(log10(azinorm)),sngl(WWW0))
        call rfill(kk+ 6,sngl(wtdelr),sngl(WWW0))
        call rfill(kk+ 7,sngl(xptt),sngl(WWW0))
        call rfill(kk+ 8,sngl(xptw),sngl(WWW0))
        call rfill(kk+ 9,sngl(xyt),sngl(WWW0))
        call rfill(kk+10,sngl(xyw),sngl(WWW0))
c with veto
        kk=20
        if(vetocut)then
          call rfill(kk+ 1,sngl(xptwt),sngl(WWW0))
