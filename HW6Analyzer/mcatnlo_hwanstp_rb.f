...
c
      call rinit("HERST.root")
      do j=1,2
        k=(j-1)*50
        call rbook(k+ 1,'t pt'//cc(j),4.e0,0.e0,400.e0)
        call rbook(k+ 2,'t eta'//cc(j),0.2e0,-9.e0,9.e0)
        call rbook(k+ 3,'tb pt'//cc(j),4.e0,0.e0,400.e0)
        call rbook(k+ 4,'tb eta'//cc(j),0.2e0,-9.e0,9.e0)
        call rbook(k+ 5,'t log[pt]'//cc(j),0.05e0,0.1e0,5.e0)
        call rbook(k+ 6,'t y'//cc(j),0.2e0,-9.e0,9.e0)
        call rbook(k+ 7,'tb log[pt]'//cc(j),0.05e0,0.1e0,5.e0)
        call rbook(k+ 8,'tb y'//cc(j),0.2e0,-9.e0,9.e0)
        if(idec.eq.0)then
          call rbook(k+11,'l+ pt'//cc(j),4.e0,0.e0,400.e0)
          call rbook(k+12,'l+ y'//cc(j),0.2e0,-4.e0,4.e0)
          call rbook(k+13,'nu pt'//cc(j),4.e0,0.e0,400.e0)
          call rbook(k+14,'nu y'//cc(j),0.2e0,-4.e0,4.e0)
          call rbook(k+15,'b pt'//cc(j),4.e0,0.e0,400.e0)
          call rbook(k+16,'b y'//cc(j),0.2e0,-4.e0,4.e0)
          call rbook(k+19,'M[W+]'//cc(j),2.e0,0.e0,200.e0)
          call rbook(k+21,'l- pt'//cc(j),4.e0,0.e0,400.e0)
          call rbook(k+22,'l- y'//cc(j),0.2e0,-4.e0,4.e0)
          call rbook(k+23,'nubar pt'//cc(j),4.e0,0.e0,400.e0)
          call rbook(k+24,'nubar y'//cc(j),0.2e0,-4.e0,4.e0)
          call rbook(k+25,'bbar pt'//cc(j),4.e0,0.e0,400.e0)
          call rbook(k+26,'bbar y'//cc(j),0.2e0,-4.e0,4.e0)
          call rbook(k+29,'M[W-]'//cc(j),2.e0,0.e0,200.e0)
        endif
      enddo
      END
...
C
      kk=0
      call rfill(kk+jj+1,sngl(pt1),sngl(WWW0))
      call rfill(kk+jj+2,sngl(eta1),sngl(WWW0))
      if(pt1.gt.0.d0)call rfill(kk+jj+5,sngl(log10(pt1)),sngl(WWW0))
      call rfill(kk+jj+6,sngl(yt1),sngl(WWW0))
      if(idec.eq.0)then
        call rfill(kk+5*jj+11,sngl(ptlp),sngl(WWW0))
        call rfill(kk+5*jj+12,sngl(ylp),sngl(WWW0))
        call rfill(kk+5*jj+13,sngl(ptnu),sngl(WWW0))
        call rfill(kk+5*jj+14,sngl(ynu),sngl(WWW0))
        call rfill(kk+5*jj+15,sngl(ptbq),sngl(WWW0))
        call rfill(kk+5*jj+16,sngl(ybq),sngl(WWW0))
        call rfill(kk+5*jj+19,sngl(xmw1),sngl(WWW0))
      endif
C
C WITH CUTS
C
